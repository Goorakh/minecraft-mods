...
public class BlockGraniteDoubleSlab extends BlockGraniteSlab
{
	public BlockGraniteDoubleSlab(String name, Material material, boolean unbreakable, float slip, float hardness, String toolClass, int toolLevel,
