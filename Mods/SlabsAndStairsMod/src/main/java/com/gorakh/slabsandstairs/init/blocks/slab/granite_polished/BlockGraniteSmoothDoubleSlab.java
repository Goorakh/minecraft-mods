...
public class BlockGraniteSmoothDoubleSlab extends BlockGraniteSmoothSlab
{
	public BlockGraniteSmoothDoubleSlab(String name, Material material, boolean unbreakable, float slip, float hardness, String toolClass, int toolLevel,
