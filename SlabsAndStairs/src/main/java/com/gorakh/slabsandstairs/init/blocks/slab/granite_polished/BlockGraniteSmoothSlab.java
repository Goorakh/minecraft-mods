...
public abstract class BlockGraniteSmoothSlab extends BlockSlab
{
	public BlockGraniteSmoothSlab(String name, Material material, boolean unbreakable, float slip, float hardness, String toolClass, int toolLevel,
	...
	{
		return Item.getItemFromBlock(BlockInit.polished_granite_slab_half);
	}
